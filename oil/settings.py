...
SECRET_KEY = 'django-insecure-13vh2$batjuilmowv&gyq92$*x#7e-dgzj(@sh)@1kyvfmzo*3'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('SQL_DATABASE', 'hack_api'),
        'USER': os.environ.get('SQL_USER', 'hack_api'),
        'PASSWORD': os.environ.get('SQL_PASSWORD', 'hack_passwd'),
